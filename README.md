...
On mobile the 'Amerta 'above the top nav is only bold/big on the inititives page, unsure why.
...
5.5) Have Ben (or whoever is in charge of the Amerta official github account) to add your user name as a "collaborator".
...
Minta Ben (atau siapa pun yang bertanggung jawab atas akun GitHub resmi Amerta) untuk menambahkan nama pengguna Anda sebagai "kolaborator".
